...
payment-legal-link-stripe-paypal = View the <stripe>Stripe privacy policy</stripe> and <paypal>Paypal privacy policy</paypal>.
...
pay-with-heading-card = Or pay with card
